...
export class MaestrosService {
  ...
  public validarMaestro(data: any, editar: boolean){
    ...
    }else if(!this.validatorService.numeric(data["sueldo"])){
      error["sueldo"] = this.errorService.numeric;
    }
  ...
  //Función para obtener los datos de un maestro por su ID, conectando con el backend
  ...
  //Creamos la petición PUT para actualizar los datos de un maestro, esta función se llamará en el método actualizar() del componente registro-maestros.ts
  //Funcion para actualizar un maestro, conectando con el backend
